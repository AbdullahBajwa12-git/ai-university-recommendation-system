...
// Illustrative only — there is no time-series analytics API yet.
const chartData = [
...
const AdminDashboard = () => {
  ...
  return (
    <div className="space-y-8 pb-12">
      <FutureScopeBanner message="The counts below are live from the database. The charts are illustrative sample visualizations — a time-series analytics API is planned as future scope." />
      ...
      {!loading && error && (
        <div className="py-12 text-center">
          ...
          <h3 className="text-lg font-bold text-white">Couldn't load admin stats</h3>
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-slate-800/50 p-8 rounded-3xl border border-slate-700">
              <h3 className="text-xl font-bold text-white mb-2">System Utilization</h3>
              <p className="text-xs text-slate-500 mb-6 uppercase tracking-widest font-bold">Illustrative sample data</p>
