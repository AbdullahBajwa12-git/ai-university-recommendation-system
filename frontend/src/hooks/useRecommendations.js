...
export const useRecommendations = () => {
    ...
    return {
        ...
        isSavedError: savedQuery.isError,
        ...
        savingUniversity: saveUniversityMutation.variables || null,
        unsaveUniversity: unsaveUniversityMutation.mutate,
        isUnsaving: unsaveUniversityMutation.isPending,
        unsavingSavedId: unsaveUniversityMutation.variables || null,
        getSessionDetails,
